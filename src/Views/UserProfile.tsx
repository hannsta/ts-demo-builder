        ...
        <SettingsContext.Consumer>
            {({settings}) => (
                ...
                <div className="flex-row flex items-center space-x-4">
                    ...
                    <div onClick={()=>setUserSelectionVisible(!userSelectionVisible)} className='w-12 h-12 p-2 flex bg-white border-2 text-3xl items-center justify-center' style={{borderRadius:'25px'}}>
